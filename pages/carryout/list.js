...
Page({
    ...
    cList: function () {
        ...
        // console.log("进入请求呀=======================");
        wx.request({
			url: encodeURI(common.xbApi.apiUrl + common.xbApi.commonurl + common.xbApi.api["did2_35"]),
			data: param,
			method: 'post',
			dataType: 'json',
			header: {
			...
			complete: function (res) {
                // console.log(res.data.resp_data.pms_t_tmonpromotionexecute[0] + "aaaaaaaaaaaaaaaaaaaaaa");
